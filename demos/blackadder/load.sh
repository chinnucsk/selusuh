...
curl -X PUT http://127.0.0.1:8091/riak/soldiers/george -d "Lt. George" -H "Content-type: text/plain" -H 'Link: </riak/soldiers/baldrick>; riaktag="underling", </riak/equipment/stick>; riaktag="equip"'

curl -X PUT http://127.0.0.1:8091/riak/soldiers/baldrick -d "Pvt. Baldrick" -H "Content-type: text/plain" -H 'Link: </riak/soldier/blackadder>; riaktag="superior", </riak/soldier/george>; riaktag="superior", </riak/equipment/stick>; riaktag="fear", </riak/equipment/wit>; riaktag="fear"'
